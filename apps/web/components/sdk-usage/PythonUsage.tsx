...
`;
  ...
  return (
    <>
      {/* Framework Selector */}
      <div className="mb-8">
        <h2 className="text-2xl font-bold text-white mb-4">Framework</h2>
      ...
      <div>
        ...
        <CodeBlock
          code={
            pythonFramework === "fastapi" ? pythonFastApiCode : pythonDjangoCode
          }
          language="python"
          title={pythonFramework === "fastapi" ? "main.py" : "views.py"}
        />
      </div>
    </>
  );
